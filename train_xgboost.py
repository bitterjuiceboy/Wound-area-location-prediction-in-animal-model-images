...
def visualize_predictions(image_paths, true_coords, pred_coords, num_samples=5):
    ...
    plt.tight_layout()
    plt.savefig('train_prediction_visualization_xgboost.png')
    plt.show()
...
def plot_error_distribution(true_coords, pred_coords):
    ...
    plt.tight_layout()
    plt.savefig('train_error_distribution_xgboost.png')
    plt.show()
...
def visualize_difficult_samples(image_paths, true_coords, pred_coords, difficult_indices, errors, num_samples=5):
    ...
    plt.tight_layout()
    plt.savefig('train_difficult_samples_visualization_xgboost.png')
    plt.show()
